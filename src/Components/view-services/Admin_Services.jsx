...
function Admin_Services() {
 ...
 useEffect(()=>{
        valor = document.querySelector("#nombreServicioh3").textContent;
                ...
                <div className="row service m-0 p-0">
                  ...
                  <div className="col-sm-6 d-grid gap-2 m-0 p-3">
                    <div className="d-flex align-items-center justify-content-between">
                      <h3 className="m-0" id="nombreServicioh3" onChange={(e) => {}}>{servicio.nombre}</h3>
                      <div className="d-flex justify-content-end">
                        <img
                          ...
                          height="22"
                          className="mx-2"
                          onClick={() => editservices (servicio.nombre)}
                        />
                        <img
                          src={ico_basura}
                          type="button"
